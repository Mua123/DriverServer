...
public class InnerClientIoHandler extends IoHandlerAdapter{
	...
	public void sessionOpened(IoSession session) throws Exception {
		System.out.println("创建session连接，发送到pioteks");
	}

	@Override
	public void sessionClosed(IoSession session) throws Exception {
		System.out.println("会话连接关闭，发送到pioteks的回话关闭");
		session.close(true);
	}

	@Override
	public void exceptionCaught(IoSession session, Throwable cause) throws Exception {
		System.out.println("发送到pioteks的回话异常");
...
//        }
	...
	public void messageSent(IoSession session, Object message) throws Exception {
		...
		System.out.println("发送到pioteks的消息发送成功" + session.getRemoteAddress() + session.getLocalAddress() +session.getServiceAddress());
	}
